...
def instance = Jenkins.getInstance()
    ...
    def sonarRunner_inst = new SonarRunnerInstallation("Sonarqube Scanner " + sonar_runner_version, "", [installSourceProperty])
    ...
    // Save the state
    instance.save()
	println("Jenkins Sonarqube plugin has been configured successfully.")